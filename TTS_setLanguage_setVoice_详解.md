...
## 2. 官方文档关于 setLanguage 的说明

> This method sets the language for the TextToSpeech engine. It also sets the voice to the default voice for the given locale.
