...
public class TtsLanguageVoiceHelper {
     ...
     * 获取引擎名称的本地化显示
     * 
     * @param engineLabel 引擎原始标签
     * @param context 上下文，用于获取当前界面语言
     * @return 本地化的引擎名称
     */
    public static String getLocalizedEngineName(String engineLabel, Context context) {
        ...
        switch (language) {
            case "zh":
                return getChineseEngineName(engineLabel);
            case "en":
                return getEnglishEngineName(engineLabel);
            default:
                return engineLabel; // 其他语言保持原样
        }
    }
     ...
     * 获取中文引擎名称
     */
    private static String getChineseEngineName(String engineLabel) {
        // 常见引擎的中文映射
        if (engineLabel.contains("Google") && engineLabel.contains("语音识别")) {
            return "Google 语音识别和语音合成";
        }
        if (engineLabel.contains("Google") && engineLabel.contains("Text-to-speech")) {
            return "Google 文字转语音";
        }
        if (engineLabel.contains("Microsoft") && engineLabel.contains("Speech")) {
            return "Microsoft 语音服务";
        }
        if (engineLabel.contains("Samsung") && engineLabel.contains("TTS")) {
            return "Samsung 文字转语音";
        }
        if (engineLabel.contains("Huawei") && engineLabel.contains("TTS")) {
            return "华为 文字转语音";
        }
        if (engineLabel.contains("Xiaomi") && engineLabel.contains("TTS")) {
            return "小米 文字转语音";
        }
        if (engineLabel.contains("OPPO") && engineLabel.contains("TTS")) {
            return "OPPO 文字转语音";
        }
        if (engineLabel.contains("vivo") && engineLabel.contains("TTS")) {
            return "vivo 文字转语音";
        }
        if (engineLabel.contains("OnePlus") && engineLabel.contains("TTS")) {
            return "一加 文字转语音";
        }
        if (engineLabel.contains("Realme") && engineLabel.contains("TTS")) {
            return "Realme 文字转语音";
        }
        if (engineLabel.contains("iFlytek") || engineLabel.contains("讯飞")) {
            return "讯飞 语音合成";
        }
        if (engineLabel.contains("Baidu") || engineLabel.contains("百度")) {
            return "百度 语音合成";
        }
        if (engineLabel.contains("Tencent") || engineLabel.contains("腾讯")) {
            return "腾讯 语音合成";
        }
        if (engineLabel.contains("Alibaba") || engineLabel.contains("阿里")) {
            return "阿里 语音合成";
        }
        if (engineLabel.contains("MultiTTS")) {
            return "MultiTTS 多语言语音合成";
        }
        if (engineLabel.contains("TTS-Server")) {
            return "TTS-Server 语音合成服务";
        }
     ...
     * 获取英文引擎名称
     */
    private static String getEnglishEngineName(String engineLabel) {
        // 常见引擎的英文映射
        if (engineLabel.contains("Google") && engineLabel.contains("语音识别")) {
            return "Google Speech Recognition and Synthesis";
        }
        if (engineLabel.contains("Google") && engineLabel.contains("Text-to-speech")) {
            return "Google Text-to-Speech";
        }
        if (engineLabel.contains("Microsoft") && engineLabel.contains("Speech")) {
            return "Microsoft Speech Services";
        }
        if (engineLabel.contains("Samsung") && engineLabel.contains("TTS")) {
            return "Samsung Text-to-Speech";
        }
        if (engineLabel.contains("Huawei") && engineLabel.contains("TTS")) {
            return "Huawei Text-to-Speech";
        }
        if (engineLabel.contains("Xiaomi") && engineLabel.contains("TTS")) {
            return "Xiaomi Text-to-Speech";
        }
        if (engineLabel.contains("OPPO") && engineLabel.contains("TTS")) {
            return "OPPO Text-to-Speech";
        }
        if (engineLabel.contains("vivo") && engineLabel.contains("TTS")) {
            return "vivo Text-to-Speech";
        }
        if (engineLabel.contains("OnePlus") && engineLabel.contains("TTS")) {
            return "OnePlus Text-to-Speech";
        }
        if (engineLabel.contains("Realme") && engineLabel.contains("TTS")) {
            return "Realme Text-to-Speech";
        }
        if (engineLabel.contains("iFlytek") || engineLabel.contains("讯飞")) {
            return "iFlytek Speech Synthesis";
        }
        if (engineLabel.contains("Baidu") || engineLabel.contains("百度")) {
            return "Baidu Speech Synthesis";
        }
        if (engineLabel.contains("Tencent") || engineLabel.contains("腾讯")) {
            return "Tencent Speech Synthesis";
        }
        if (engineLabel.contains("Alibaba") || engineLabel.contains("阿里")) {
            return "Alibaba Speech Synthesis";
        }
        if (engineLabel.contains("MultiTTS")) {
            return "MultiTTS Multi-language Speech Synthesis";
        }
        if (engineLabel.contains("TTS-Server")) {
            return "TTS-Server Speech Synthesis Service";
        }
